class_name TutorialStickHint
extends Control
## Small stick box for the instructor card: a ring shows where the stick is now and a
## pulsing arrow shows where the lesson wants it. Screen convention: up = Vector2(0, -1).
